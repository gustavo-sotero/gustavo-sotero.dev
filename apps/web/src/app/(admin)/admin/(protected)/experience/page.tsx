...
import { useAdminExperience, useDeleteExperience } from '@/hooks/admin/use-admin-experience';
...
export default function AdminExperiencePage() {
  ...
  return (
    <AdminListShell
      ...
      skeletonCount={5}
      emptyIcon={<Briefcase className="h-8 w-8 text-zinc-700" />}
              ...
              <AlertDialogContent className="bg-zinc-900 border-zinc-800">
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription className="text-zinc-400">
                    <strong className="text-zinc-300">{item.role}</strong> na {item.company} será
                    removido.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
