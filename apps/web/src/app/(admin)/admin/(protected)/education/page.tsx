...
import { ChevronLeft, ChevronRight, GraduationCap, Pencil, Plus, Trash2 } from 'lucide-react';
...
import { useAdminEducation, useDeleteEducation } from '@/hooks/use-admin-queries';
  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-xl font-semibold text-zinc-100">Formação</h1>
      ...
      <div className="rounded-lg border border-zinc-800 bg-zinc-900/40 overflow-hidden">
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center gap-3 py-14 text-center">
            ...
            <p className="text-sm text-zinc-500">Nenhuma formação cadastrada</p>
            <Button
              asChild
              size="sm"
              className="h-8 gap-1.5 bg-emerald-500 hover:bg-emerald-600 text-white"
                  ...
                  <AlertDialogContent className="bg-zinc-900 border-zinc-800">
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription className="text-zinc-400">
                        <strong className="text-zinc-300">{item.title}</strong> em{' '}
                        {item.institution} será removido.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
