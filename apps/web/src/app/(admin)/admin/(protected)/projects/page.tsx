...
import { useAdminProjects, useDeleteProject } from '@/hooks/admin/use-admin-projects';
...
export default function AdminProjectsPage() {
  ...
  return (
    <AdminListShell
      title="Projetos"
      subtitle={meta ? `${meta.total} projeto${meta.total !== 1 ? 's' : ''}` : ' '}
      headerRight={
        <>
          <Select
            value={status}
      ...
      emptyIcon={<FolderGit2 className="h-8 w-8 text-zinc-700" />}
          ...
          <div className="w-20 flex items-center justify-end gap-1">
            ...
            <AlertDialog>
              ...
              <AlertDialogContent className="bg-zinc-900 border-zinc-800">
                <AlertDialogHeader>
                  <AlertDialogTitle className="text-zinc-100">Excluir projeto?</AlertDialogTitle>
                  <AlertDialogDescription className="text-zinc-400">
                    <strong className="text-zinc-300">{project.title}</strong> será removido. Esta
                    ação usa soft delete.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
