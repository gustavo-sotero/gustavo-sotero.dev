...
export default function Experience() {
  ...
  return (
    <section id="experience" className="py-16 md:py-24" ref={ref}>
      <h2 className="text-2xl font-bold tracking-tight sm:text-3xl md:text-4xl mb-8">{t("experience.title")}</h2>
      ...
      >
        {experiences.map((exp) => (
          <motion.div key={exp.id} variants={item} className="mb-10 relative">
