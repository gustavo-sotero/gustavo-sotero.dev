...
export default function Blog() {
  ...
  const filteredPosts = blogPosts.filter((post) => {
    ...
    return postTitle.includes(query) || postExcerpt.includes(query) || postTags.includes(query)
  })
  ...
  return (
    <section id="blog" className="py-16 md:py-24" ref={ref}>
      ...
      >
        <h2 className="text-2xl font-bold tracking-tight sm:text-3xl md:text-4xl mb-8">{t("blog.title")}</h2>
