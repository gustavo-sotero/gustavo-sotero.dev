...
export default function Education() {
  ...
  return (
    <section id="education" className="py-16 md:py-24" ref={ref}>
      <h2 className="text-2xl font-bold tracking-tight sm:text-3xl md:text-4xl mb-8">{t("education.title")}</h2>
      ...
      >
        {educations.map((edu) => (
          <motion.div key={edu.id} variants={item} className="mb-10 relative">
