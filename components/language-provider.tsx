    ...
    (key: string): string => {
      ...
      for (const part of parts) {
        if (result && typeof result === "object" && part in result) {
          ...
          if (language !== "en") {
            let fallbackResult: string | TranslationObject | undefined = translations.en
            for (const fbPart of parts) {
              if (fallbackResult && typeof fallbackResult === "object" && fbPart in fallbackResult) {
                fallbackResult = fallbackResult[fbPart] as string | TranslationObject
              } else {
