...
export default function Projects() {
  ...
  return (
    <section id="projects" className="py-16 md:py-24" ref={ref}>
      <h2 className="text-2xl font-bold tracking-tight sm:text-3xl md:text-4xl mb-8">{t("projects.title")}</h2>
          ...
          <motion.div key={project.id} variants={item}>
            <Card className="h-full flex flex-col">
              ...
              <CardContent className="flex-grow">
                ...
                <CardDescription className="text-primary mb-4">{project.impact}</CardDescription>
      ...
      <div className="mt-8 flex justify-center">
        <Button variant="outline" onClick={() => setShowAll(!showAll)} className="gap-1">
          {showAll ? (
            <>
              <ChevronUp size={16} />
              {t("projects.showLess")}
